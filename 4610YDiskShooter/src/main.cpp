...
double flywheelkP = 0.25;
double flywheelkI = 0.001;
double flywheelkD = 0.01;
...
int flywheelPID() {
  while(enableFlywheelPID) {
    ...
    double flywheelMotorPower = flywheelError * flywheelkP;
    //  + flywheelDerivative * flywheelkD + flywheelTotalError * flywheelkI;
